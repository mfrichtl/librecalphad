...
disabled_phases = ['BCC_B2', 'BCC_D03', 'FCC_L10', 'FCC_L12', 'HCP_L12', 'GAS', 'IONIC_LIQ', 'SIGMA_H']
phases = [phase for phase in list(db.phases.keys()) if phase not in disabled_phases]

for temp in [1073, 1173, 1273, 1373, 1473]:
    conds = {v.T: temp, v.P: 101325, v.X('FE'): (0, 1, 0.01), v.X('CO'): (0, 1, 0.01)}
    plt.figure(figsize=(20,20))
    ternplot(db, comps, phases, conds, x=v.X('CO'), y=v.X('FE')) 
